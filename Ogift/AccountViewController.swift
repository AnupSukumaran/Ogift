...
class AccountViewController: UIViewController, WKNavigationDelegate, UIScrollViewDelegate, UITabBarControllerDelegate {
    ...
    func callToMail() {
        print("CalledHere")
        let url = NSURL(string: "mailto:support@ogift.in?subject=Ogift_Support")
